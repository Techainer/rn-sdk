...
#ifndef EKYC_IOS_SDK_SWIFT_H
#define EKYC_IOS_SDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ekyc_ios_sdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12ekyc_ios_sdk16CardValidateView")
@interface CardValidateView : UIView <AVCapturePhotoCaptureDelegate, AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)layoutSubviews;
...
@interface CardValidateView (SWIFT_EXTENSION(ekyc_ios_sdk))
...
SWIFT_CLASS("_TtC12ekyc_ios_sdk24FaceAuthentication3DView") SWIFT_AVAILABILITY(ios,introduced=11.1)
@interface FaceAuthentication3DView : UIView <AVCaptureDataOutputSynchronizerDelegate>
- (void)didMoveToSuperview;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
...
- (void)setShowInstructionShadow:(BOOL)enabled;
- (void)setPlaceInstructionBelow:(BOOL)enabled;
- (void)didMoveToSuperview;
- (void)layoutSubviews;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
...
@interface FaceAuthenticationView (SWIFT_EXTENSION(ekyc_ios_sdk))
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end

SWIFT_CLASS("_TtC12ekyc_ios_sdk16FaceValidateView")
@interface FaceValidateView : UIView <AVCapturePhotoCaptureDelegate, AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)layoutSubviews;
- (void)didMoveToSuperview;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
