...
#ifndef LIVENESSCLOUD_SWIFT_H
#define LIVENESSCLOUD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LivenessCloud",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13LivenessCloud23LivenessUtilityDetector") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
SWIFT_CLASS("_TtC13LivenessCloud21DepthLivenessDetector") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
@interface DepthLivenessDetector (SWIFT_EXTENSION(LivenessCloud)) <ARSCNViewDelegate>
...
SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface DepthLivenessDetector (SWIFT_EXTENSION(LivenessCloud)) <ARSessionDelegate>
...
SWIFT_CLASS("_TtC13LivenessCloud11ImageAction")
...
SWIFT_CLASS("_TtC13LivenessCloud18LivenessCalculator") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
static NSString * _Nonnull const LivenessErrorDomain = @"LivenessCloud.LivenessError";
...
SWIFT_CLASS("_TtC13LivenessCloud16LivenessResponse")
...
SWIFT_CLASS("_TtC13LivenessCloud14LivenessResult")
...
SWIFT_CLASS("_TtC13LivenessCloud12LivenessUtil") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
SWIFT_PROTOCOL("_TtP13LivenessCloud31LivenessUtilityDetectorDelegate_") SWIFT_AVAILABILITY(ios,introduced=13.0)
@protocol LivenessUtilityDetectorDelegate
@optional
...
SWIFT_CLASS("_TtC13LivenessCloud10Networking") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface Networking (SWIFT_EXTENSION(LivenessCloud))
