...
#ifndef THERMALLIVENESSCLOUD_SWIFT_H
#define THERMALLIVENESSCLOUD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ThermalLivenessCloud",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20ThermalLivenessCloud23LivenessUtilityDetector") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
SWIFT_CLASS("_TtC20ThermalLivenessCloud21DepthLivenessDetector") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface DepthLivenessDetector : LivenessUtilityDetector
- (nonnull instancetype)initWithPreviewView:(UIView * _Nonnull)previewView threshold:(enum LivenessUtilitySensitivityThreshold)threshold delay:(double)delay smallFaceThreshold:(double)smallFaceThreshold debugging:(BOOL)debugging isWink:(BOOL)isWink isSmile:(BOOL)isSmile transactionId:(NSString * _Nonnull)transactionId frameTime:(double)frameTime isOnlyLiveness:(BOOL)isOnlyLiveness OBJC_DESIGNATED_INITIALIZER;
...
@interface DepthLivenessDetector (SWIFT_EXTENSION(ThermalLivenessCloud)) <ARSCNViewDelegate>
...
SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface DepthLivenessDetector (SWIFT_EXTENSION(ThermalLivenessCloud)) <ARSessionDelegate>
...
SWIFT_CLASS("_TtC20ThermalLivenessCloud11ImageAction")
...
SWIFT_CLASS("_TtC20ThermalLivenessCloud18LivenessCalculator") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface LivenessCalculator : NSObject
- (void)calculateLivenessWithTransactionId:(NSString * _Nonnull)transactionId frame:(ARFrame * _Nonnull)frame isOnlyLiveness:(BOOL)isOnlyLiveness onDone:(void (^ _Nullable)(BOOL, float, float, BOOL, NSString * _Nonnull, UIImage * _Nonnull, LivenessResult * _Nullable))onDone;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
typedef SWIFT_ENUM(NSInteger, LivenessError, open) {
  ...
  LivenessErrorTwoFace = 5,
  LivenessErrorHangError = 6,
};
static NSString * _Nonnull const LivenessErrorDomain = @"ThermalLivenessCloud.LivenessError";
...
SWIFT_CLASS("_TtC20ThermalLivenessCloud16LivenessResponse")
...
SWIFT_CLASS("_TtC20ThermalLivenessCloud14LivenessResult")
...
SWIFT_PROTOCOL("_TtP20ThermalLivenessCloud31LivenessUtilityDetectorDelegate_") SWIFT_AVAILABILITY(ios,introduced=13.0)
@protocol LivenessUtilityDetectorDelegate
@optional
...
- (void)livenessWithLiveness:(LivenessUtilityDetector * _Nonnull)liveness didFinish:(UIImage * _Nonnull)verificationImage livenesScore:(float)livenesScore faceMatchingScore:(float)faceMatchingScore result:(BOOL)result message:(NSString * _Nonnull)message videoURL:(NSURL * _Nullable)videoURL response:(LivenessResult * _Nullable)response;
- (void)livenessWithLiveness:(LivenessUtilityDetector * _Nonnull)liveness didFinish:(BOOL)result message:(NSString * _Nonnull)message videoURL:(NSURL * _Nullable)videoURL response:(LivenessResult * _Nullable)response;
@end
...
SWIFT_CLASS("_TtC20ThermalLivenessCloud10Networking") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface Networking : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) Networking * _Nonnull shared;)
+ (Networking * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (void)setupWithAppId:(NSString * _Nonnull)appId logLevel:(enum LogLevel)logLevel url:(NSString * _Nonnull)url publicKey:(NSString * _Nonnull)publicKey privateKey:(NSString * _Nonnull)privateKey;
- (LivenessResponse * _Nonnull)generateDeviceInforWithDeviceId:(NSString * _Nonnull)deviceId additionParam:(NSDictionary<NSString *, id> * _Nonnull)additionParam paramHeader:(NSDictionary<NSString *, NSString *> * _Nonnull)paramHeader ownerId:(NSString * _Nonnull)ownerId SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface Networking (SWIFT_EXTENSION(ThermalLivenessCloud))
